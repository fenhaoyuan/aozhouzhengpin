...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <span class="list-view-img-active"><?php echo $text_list; ?></span><a onclick="display(\'grid\');"><span class="grid-view-img"><?php echo $text_grid; ?></span></a>');
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <a onclick="display(\'list\');"><span class="list-view-img"><?php echo $text_list; ?></span></a><span class="grid-view-img-active"><?php echo $text_grid; ?></span>');
